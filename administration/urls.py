...
urlpatterns = [
    ...
    # MATCH EVENT
    path('generate-result/<slug:slug>', ResultCreateView.as_view(), name='create-result'),
    

    # MATCH
    path('fixtures-list/', FixtureListView.as_view(), name='fixtures-list'),
    path('results-list/', ResultListView.as_view(), name='results-list'),
